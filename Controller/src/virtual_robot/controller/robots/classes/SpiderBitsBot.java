 ...
 *
 */
@BotConfig(name = "SpiderBitsBot", filename = "spiderbits-bot")
public class SpiderBitsBot extends VirtualBot {
    ...
    protected void createHardwareMap(){
        ...
        String[] motorNames = new String[] {"backLeft", "front_left_motor", "front_right_motor", "back_right_motor"};
