 ...
 *
 */
@Autonomous(name = "AutonomousExample_Pooja", group = "SB^2 Two Wheel")
public class AutonomousExample_Pooja extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // 3) Turn left moving backwards
        // Left wheel half power backwards, right wheel full power backward
